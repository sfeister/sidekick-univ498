...
drvAsynSerialPortConfigure("debug_ino","/dev/ttyUSB-arduino1.1")
asynSetOption("debug_ino",0,"baud","115200")
asynSetOption("debug_ino",0,"bits","8")
asynSetOption("debug_ino",0,"parity","none")
asynSetOption("debug_ino",0,"stop","1")
asynSetOption("debug_ino",0,"clocal","Y")
asynSetOption("debug_ino",0,"crtscts","N")
