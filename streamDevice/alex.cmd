...
drvAsynSerialPortConfigure("alex_ino","/dev/ttyUSB-arduino1.1")
asynSetOption("alex_ino",0,"baud","9600")
asynSetOption("alex_ino",0,"bits","8")
asynSetOption("alex_ino",0,"parity","none")
asynSetOption("alex_ino",0,"stop","1")
asynSetOption("alex_ino",0,"clocal","Y")
asynSetOption("alex_ino",0,"crtscts","N")
